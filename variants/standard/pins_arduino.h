...
#elif defined(__MD328P__) || defined(__MD328D__)
...
#define MD_NOT_DACO(pin) ((pin != DAC0) && (pin != DAC1))
#elif defined(__MD328P__)
#define MD_NOT_DACO(pin) (pin != DAC0)
#else
#define MD_NOT_DACO(pin) 1
#endif
...
#define	D38	38	/* PF6 */
#define	D39	39	/* PF7 */
#define OC3C 40 /* PF3 for OC3C */
#define D40 40	/* PF3 for OC3C */
